...
def main():
    ...
    add_video_item('http://198.100.158.231:1935/kanal30/_definst_/livestream/chunklist_w1012777298.m3u8'						,{ 'title': 'kurdistan24 TV'}, icons + 'kurdistan24-tv.png')
    ...
    add_video_item('http://stream-07.vty.dailymotion.com/10/dm/1/x1l65xy/live.isml/events(live-1449672404)/live-audio=128000-video=700000.m3u8'						,{ 'title': 'IMC TV'}, icons + 'imc-tv.png')
