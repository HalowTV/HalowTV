...
def main():
    ...
    add_video_item('http://avenuewtv.srfms.com:2219/live/livestream/playist.m3u8',{ 'title': '[COLOR yellow][B]WAAR TV [COLOR red][B][HD][/B][/COLOR]'}, icons + 'http://karwan.tv/images/tvlogo/waar-tv.png')
    ...
    add_video_item('http://origin2.live.web.tv.streamprovider.net/streams/4da1be863730bb975a52b3341be8f037/index.m3u8'	,{ 'title': '[COLOR yellow][B]Halk TV [COLOR red][B][HD][/B][/COLOR]'}, icons + 'http://karwan.tv/images/tvlogo/halk-tv.png')
    add_video_item('http://origin.live.web.tv.streamprovider.net/streams/e3490d55c5dfc38e758ade69815cd9ef_live_0_0/index.m3u8' ,{ 'title': '[COLOR yellow][B]JIYAN TV [COLOR red][B][HD][/B][/COLOR]'}, icons + 'http://karwan.tv/images/tvlogo/jiyan-tv.PNG')
