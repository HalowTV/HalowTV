...
def main():
    ...
    add_video_item('http://stream-ec.vty.dailymotion.com/37/dm/1/x32d5ky/live.isml/events(live-1454022348)/live-video=700000.m3u8'       ,{ 'title': 'Biaban Family HD'}, icons + 'http://ladda-upp.se/files/2016/b180019.jpg')
