...
def main():
    ...
    add_video_item('http://87.81.198.172:80/hls/mystream.m3u8'       ,{ 'title': 'ROJIKurd'}, icons + 'rojava-tv')
    add_video_item('rtmp://87.81.198.172:12345/hls/mystream'       ,{ 'title': 'ROJIKurd SD'}, icons + 'rojava-tv')
