...
ADDON=xbmcaddon.Addon(id='plugin.program.HalowTV')
    
    
VERSION = "1.0.0"
PATH = "JMSoccer Wizard"            

    
def CATEGORIES():
    link = OPEN_URL('http://halowtv.com/wizard.txt/HalowTv.txt').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("HalowTV Wizard","Downloading ",'', 'Please Wait')
